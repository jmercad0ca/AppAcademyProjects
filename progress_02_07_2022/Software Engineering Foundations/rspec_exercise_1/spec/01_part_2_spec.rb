...
describe "Part 2:" do
  describe "hipsterfy" do
    ...
    it "should not accept anything besides a word as an arg" do
      expect { hipsterfy([]) }.to raise_exception
      expect { hipsterfy(10) }.to raise_exception
      expect { hipsterfy(false) }.to raise_exception
      expect { hipsterfy(nil) }.to raise_exception
    end
    ...
    it "should return the word with it's last vowel (a, e, i, o, u) removed" do
      ...
      expect(hipsterfy("lease")).to eq("leas")
    end
  ...
  describe "vowel_counts" do
    ...
    it "should not accept anything besides a string as an arg" do
      expect { vowel_counts([]) }.to raise_exception
      expect { vowel_counts(10) }.to raise_exception
      expect { vowel_counts(false) }.to raise_exception
      expect { vowel_counts(nil) }.to raise_exception
    end
    ...
    it "should return a hash where each key is a vowel of string and it's value is the number of times it appears" do
      ...
      expect(vowel_counts("WILLIAMSBURG bridge")).to include({"i"=>3, "a"=>1, "u"=>1, "e"=>1})
      expect(vowel_counts("bcdfghjklmnpqrstvwxyz")).to include({})
    end
  end
  ...
  describe "caesar_cipher" do
    ...
    it "should not accept anything besides a string and number as args" do
      expect { caesar_cipher([],[]) }.to raise_exception
      expect { caesar_cipher(10, 10) }.to raise_exception
      expect { caesar_cipher(false,false) }.to raise_exception
      expect { caesar_cipher(nil,nil) }.to raise_exception
      expect { caesar_cipher("","") }.to raise_exception
    end
